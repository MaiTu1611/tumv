			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">Runsystem</span>
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form name='loginForm'
											...
											method="POST">
											<fieldset>
												<label class="block clearfix"> ${msg} </label> <label
									...
									<div class="toolbar clearfix">
										<div>
											<a href="#" class="forgot-password-link"> <i
												class="ace-icon fa fa-arrow-left"></i> Comback Home Page
											</a>
										</div>
									</div>
								</div>
